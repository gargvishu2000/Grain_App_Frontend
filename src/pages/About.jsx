  ...
  return (
    <div className='text-xl text-center pt-8 border-t'>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        <img src='item.png' className='w-full max-w-[450px]' />
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray-500'>
          <p className='text-md'>GrainTrade was established with a vision to modernize and streamline the grain trading industry. Our platform bridges the gap between grain producers, traders, and buyers, creating an efficient marketplace for bulk grain transactions.</p>
          ...
          <p className='text-md'>Our mission at GrainTrade is to revolutionize the grain trading industry by providing a secure, transparent, and efficient platform for B2B transactions. We're committed to empowering businesses with real-time market insights, quality assurance, and seamless trading operations.</p>
        </div>
      </div>
